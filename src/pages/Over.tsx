    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0F172A] text-white py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4"><span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-300">Over ArboMatcher</span></h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="bg-slate-50 rounded-2xl border border-slate-200 p-5 sm:p-8 text-center">
