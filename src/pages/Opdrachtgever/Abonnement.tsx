      ...
      <div className="bg-white p-8 rounded-lg shadow-lg">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-3xl font-bold text-[#0F172A] mt-2">
              €149<span className="text-lg text-gray-600">/maand</span>
            </p>
          </div>
        ...
        <div className="border-t pt-6">
          ...
          <div className="flex items-center p-4 bg-gray-50 rounded-lg">
            <CreditCard className="w-8 h-8 text-gray-500 mr-4" />
            <div>
              <p className="font-semibold text-gray-700">Betaalmethode</p>
              <p className="text-sm text-gray-600">Creditcard eindigend op 4242</p>
            </div>
          </div>
        </div>
