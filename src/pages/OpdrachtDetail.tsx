...
export default function OpdrachtDetail() {
  ...
  const handleApply = async () => {
    ...
    if (profile?.role !== 'ARTS') {
      alert('Alleen professionals kunnen reageren op opdrachten');
      return;
    }
    ...
    if (!doctor) {
      alert('Eerst uw profiel aanmaken');
      navigate('/arts/profiel');
      return;
    }

    if (doctor.verification_status !== 'VERIFIED') {
      alert('Uw profiel moet eerst geverifieerd worden door een admin');
      return;
    }
  ...
  if (!job) {
    return (
      <div className="pt-16 min-h-screen bg-[#F3F4F6]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {!user && (
              <Link
                to="/register"
                className="inline-flex items-center justify-center bg-[#4FA151] text-white px-6 py-3 rounded-[12px] font-semibold hover:bg-[#3E8E45] transition whitespace-nowrap"
              >
                Direct reageren
              </Link>
            )}
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      <button
                        onClick={handleApply}
                        disabled={applying}
                        className="flex-1 bg-[#4FA151] text-white py-3 rounded-[12px] font-semibold hover:bg-[#3E8E45] transition disabled:opacity-50"
                      >
            ...
            <div className="bg-white rounded-[16px] p-6 border border-gray-100 sticky top-24">
              ...
              {!user && (
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <Link
                    to="/register"
                    className="w-full inline-flex items-center justify-center bg-[#4FA151] text-white py-3 rounded-[12px] font-semibold hover:bg-[#3E8E45] transition"
                  >
                    Direct reageren
                  </Link>
        ...
        {!user && (
          <div className="mt-12 bg-gradient-to-br from-[#0F172A] to-[#1E293B] rounded-[16px] p-8 sm:p-12 text-white">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4">Volledige opdracht bekijken en reageren?</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  to="/register"
                  className="px-8 py-3 bg-[#4FA151] rounded-[12px] font-semibold hover:bg-[#3E8E45] transition flex items-center justify-center gap-2 shadow-lg shadow-[#4FA151]/25"
                >
                  Gratis registreren
