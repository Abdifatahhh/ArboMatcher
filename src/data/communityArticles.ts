...
**Kan ik ook zonder BIG op het platform?** Je kunt je aanmelden en je profiel bekijken, maar om te solliciteren op opdrachten is een geverifieerd BIG-nummer vereist.`,
  },
  {
    ...
    title: 'Zo plaats je een effectieve opdracht als opdrachtgever',
    date: '8 feb 2026',
...
- Ervaring (bijv. aantal jaren, type opdrachtgever)
- Locatie: op locatie, hybride of volledig op afstand
- Taal of andere randvoorwaarden

## Reageer tijdig op sollicitaties

Artsen investeren tijd in een reactie. Stel ze op de hoogte van de status – ontvangen, in behandeling, shortlist – en geef binnen een paar werkdagen een eerste reactie. Zo blijft het platform aantrekkelijk voor goede kandidaten en bouw je een goede reputatie op als opdrachtgever.
...
- Houd kandidaten op de shortlist op de hoogte van vervolgstappen`,
  },
  {
    ...
    content: `Een passend uurtarief is belangrijk voor je inkomsten én voor je positie op de markt. Te laag trekt misschien opdrachten aan maar doet geen recht aan je expertise; te hoog kan opdrachtgevers afschrikken. In dit artikel vind je handvatten om je tarief te bepalen en transparant te communiceren.
...
Op ArboMatcher kun je je tarief of een bandbreedte in je profiel vermelden. Dat schept helderheid voor opdrachtgevers en voorkomt onnodige gesprekken over budget. Je kunt altijd per opdracht afwijken als de omstandigheden dat rechtvaardigen.`,
  },
  {
...
Wet- en regelgeving kan wijzigen. We houden onze community en artikelen bij met algemene uitleg; voor juridisch of fiscaal advies raadpleeg altijd een deskundige. Heb je vragen over hoe ArboMatcher aansluit op verzuimwetgeving of inzet van artsen in jouw situatie? Neem contact met ons op.`,
  },
  {
    ...
    title: 'Je profiel optimaliseren: zo val je op bij opdrachtgevers',
    date: '28 jan 2026',
    category: 'Voor artsen',
    imageUrl: IMG.profile,
    imageAlt: 'Profiel en cv',
    content: `Een sterk profiel op ArboMatcher vergroot de kans dat opdrachtgevers je uitnodigen of dat je reacties snel worden opgepakt. In dit artikel lees je wat opdrachtgevers het meest belangrijk vinden en hoe jij je profiel daarmee scherper maakt.

## Volledig en actueel profiel

Zorg dat alle velden ingevuld zijn: BIG-nummer (geverifieerd), specialismen, regio('s), beschikbaarheid en een korte bio. Een onvolledig profiel oogt onprofessioneel en opdrachtgevers filteren vaak op "compleet profiel". Werk je gegevens bij zodra iets verandert – bijvoorbeeld een nieuwe specialisatie of andere beschikbaarheid.
...
Schrijf in een paar zinnen wie je bent, wat je doet en wat je toegevoegde waarde is. Bijvoorbeeld: ervaring met langdurig verzuim, focus op mentale belasting, of juist breed inzetbaar voor PMO en verzuim. Geen lange verhalen; wel concreet en relevant voor opdrachtgevers die snel moeten scannen.

- Wie ben je en wat is je achtergrond?
- Waar ben je goed in of waar wil je je op richten?
- Wat maakt jouw inzet waardevol voor een opdrachtgever?

## Specialismen en regio

Wees eerlijk en specifiek. "Bedrijfsarts" is goed; "verzuimbegeleiding en re-integratie" of "preventief medisch onderzoek" maakt het nog duidelijker. Kies de regio's waar je daadwerkelijk wilt werken; opdrachtgevers zoeken vaak op regio en willen weten of je ter plaatse of op afstand beschikbaar bent.
...
Als je een indicatie van je tarief en je beschikbaarheid (uren per week, startdatum) vermeldt, weten opdrachtgevers sneller of je past. Je hoeft niet tot op de euro precies te zijn; een bandbreedte of "in overleg" kan ook. Reageer daarnaast tijdig op opdrachten en op berichten; dat verhoogt je zichtbaarheid en betrouwbaarheid op het platform.

- Tarief of bandbreedte vermelden vergroot de kans op serieuze matches
- Duidelijke beschikbaarheid voorkomt misverstanden
- Snel reageren wordt door opdrachtgevers gewaardeerd`,
  },
];
