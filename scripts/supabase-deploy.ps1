# Zoekt Node.js en deployt de BIG-check Edge Function (ook als npm niet in PATH staat)
...
Write-Host "BIG-check Edge Function deployen..."
& $supabaseCmd functions deploy big-check
